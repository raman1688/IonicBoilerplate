...
'use strict';
app.factory('decServiceFactory', ['$http', '$log', '$q', '$state', '$translate', '$rootScope', '$timeout', '$ionicLoading', 'constants', 'messageService', 'userSessionDataFactory', function($http, $log, $q,$state,$translate,$rootScope,$timeout,$ionicLoading,constants,messageService,userSessionDataFactory) {
